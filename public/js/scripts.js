...
$(document).ready(function () {
    ...
    $(document).on('click', '#EffortDev', function(){drawNewHighCharts("#EffortDev",$('#EffortDev').text())});

    $(document).on('click', '#EffortPM', function(){drawNewHighCharts("#EffortPM",$('#EffortPM').text())});

    $(document).on('click', '#EffortSyn', function(){drawNewHighCharts("#EffortSyn",$('#EffortSyn').text())});

    $(document).on('click', '#Business', function(){drawNewHighCharts("#Business",$('#Business').text())});

    $(document).on('click', '#EffortBV', function(){drawNewHighCharts("#EffortBV",$('#EffortBV').text())});
